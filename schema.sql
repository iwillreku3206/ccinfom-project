...
-- Schema ccinfom_db
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `ccinfom_db` DEFAULT CHARACTER SET utf8 ;
USE `ccinfom_db` ;
...
CREATE TABLE IF NOT EXISTS `ccinfom_db`.`login_history` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `login_history_userFK_idx` (`user` ASC) VISIBLE,
  CONSTRAINT `login_history_userFK`
    FOREIGN KEY (`user`)
    REFERENCES `ccinfom_db`.`users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `ccinfom_db`.`trade_history`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ccinfom_db`.`trade_history` (
  `id` INT NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `trade_historytoFK_idx` (`to_user` ASC) VISIBLE,
  INDEX `trade_historyfromFK_idx` (`from_user` ASC) VISIBLE,
  INDEX `trade_historyitemFK_idx` (`item` ASC) VISIBLE,
  CONSTRAINT `trade_historyfromFK`
    FOREIGN KEY (`from_user`)
    REFERENCES `ccinfom_db`.`users` (`id`)
    ON DELETE RESTRICT
    ON UPDATE NO ACTION,
  CONSTRAINT `trade_historytoFK`
    FOREIGN KEY (`to_user`)
    REFERENCES `ccinfom_db`.`users` (`id`)
    ON DELETE RESTRICT
    ON UPDATE NO ACTION,
  CONSTRAINT `trade_historyitemFK`
    FOREIGN KEY (`item`)
    REFERENCES `ccinfom_db`.`items` (`id`)
    ON DELETE RESTRICT
    ON UPDATE NO ACTION)
